...
public class Board extends JPanel
{
    ...
    public boolean continueGame()
    {
        ...
        return turn < 105 && whiteAlive && blackAlive;
    }
    ...
    public void move(int startRow, int startCol, int endRow, int endCol)
    {
        ...
        if (hasPiece(startRow,startCol))
        {
            ...
            if (piece.legalMove(startRow,startCol,endRow,endCol))
            {
                ...
                //b.remove(startRow,startCol);
                //b.remove(endRow,endCol);
                //b.add(piece,endRow,endCol);
            }
        }
    }
    ...
    public Image pic (Image img, int width, int height)//Method to get create pictures
    {
        //Allows you to set size of image accordingly
